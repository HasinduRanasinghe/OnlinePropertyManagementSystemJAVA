	        	...
	        	<div class="card border-0 shadow rounded-3 my-5">
	          		<div class="card-body p-5 p-sm-5">
	            		...
	            		<form action="userReg" method="post">
		            		...
		            		<div class="d-grid">
		                		<button class="btn btn-primary btn-login text-uppercase fw-bold" onclick="valid()" type="submit">Register</button>
		            		</div>
		            		<hr class="my-4">
	
		            		<div class="text-center pt-5">
		            			<p>Already a member?<a href="userLogin.jsp">Login</a></p>
		            		</div>
	          			</form>		
	        		</div>
	      		</div>
