...
<body>
  		...
  		<div class="container">
    		...
    		<div class="collapse navbar-collapse" id="navbarSupportedContent">
      			...
      			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        			...
        			<li class="nav-item">
          				<a class="nav-link active" aria-current="page" href="#">Lands</a>
        			</li>
        			...
        			<li class="nav-item">
          				<a class="nav-link active" aria-current="page" href="addLands.jsp">Add Lands</a>
        			</li>
	...
	<%
		try{
			...
			String sql = "Select * From onlinepropertymanagement.landsdetails";
			...
			<div class="row mx-auto pt-5 pb-5">
			  ...
			  <div class="col ">
			    ...
			    <div class="img-area mb-4 mt-4">
	            	<center><img src="landImages/<%=resultSet.getString("filepath")%>" class="center img-fluid" alt=""></center>
	            </div>
	            
			      <div class="card-body">
			         
			         <h5 class="card-title"><%=resultSet.getString("landID")%></h5>
		            ...
		            <div class="d-grid pb-2">
		                		<button class="btn btn-primary btn-login text-uppercase fw-bold" onclick="window.location.href='updateLands.jsp';" type="submit">Update</button>
		            </div>
		            
		            <div class="d-grid">
		                		<button class="btn btn-primary btn-login text-uppercase fw-bold" onclick="window.location.href='deleteLands.jsp';" type="submit">Delete</button>
		            </div>
