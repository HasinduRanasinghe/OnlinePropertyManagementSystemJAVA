	    	...
	    	<div class="col-sm-9 col-md-7 col-lg-5 mx-auto pt-5">
	        	<div class="card border-0 shadow rounded-3 my-5">
	          		<div class="card-body p-5 p-sm-5">
	            		<h5 class="card-title text-center mb-5 fw-light fs-5">Delete House</h5>
	            		
	            		<form action="deleteHouses" method="post">
		              		
		              		<div class="form-floating mb-3">
		                		<input type="text" name="houseID" class="form-control" id="floatingLID" placeholder=" " required>
		                		<label for="floatingLID">House ID</label>
		              		</div>
		            		<div class="d-grid pt-2">
		                		<button class="btn btn-primary btn-login text-uppercase fw-bold" type="submit">Delete</button>
		            		</div>
