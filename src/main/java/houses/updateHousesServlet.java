...
@MultipartConfig
/**
 * Servlet implementation class updateHousesServlet
 */
public class updateHousesServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = HousesDB.updateHouses(location, size, price, owner, ownerContact, description, filepath, houseID);

		if (isTrue == true) {

			RequestDispatcher dis = request.getRequestDispatcher("houses.jsp");
